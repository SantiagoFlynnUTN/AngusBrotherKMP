...
import com.angus.service_restaurant.domain.utils.exceptions.INVALID_PAGE
import com.angus.service_restaurant.domain.utils.exceptions.INVALID_PAGE_LIMIT
...
class Validation : IValidation {
    ...
    override fun isValidPhone(phone: String?, currency: String): Boolean {
        ...
        return true //phone != null && phone.matches(Regex(phoneRegex))
    }
