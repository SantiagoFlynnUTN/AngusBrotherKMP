...
interface IExploreRestaurantUseCase {
    ...
    suspend fun getMealsHomePage(): List<Cuisine>
}

class ExploreRestaurantUseCase(
    private val restaurantGateway: IRestaurantGateway,
    private val mealDataSource: CuisineMealsPagingSource,
    private val homeMealsDataSource: HomeMealsPagingSource,
    ...
    override suspend fun getMealsHomePage(): List<Cuisine> {
        return restaurantGateway.getCuisinesWithMealsInRestaurant("65bf0219728b2a589064a171")
    }
}
