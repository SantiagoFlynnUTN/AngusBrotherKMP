...
import com.angus.api_gateway.data.model.identity.UserDetailsDto
import com.angus.api_gateway.data.model.identity.UserDto
import com.angus.api_gateway.data.model.identity.UserOptions
...
import com.angus.api_gateway.util.Claim.PERMISSION
...
class IdentityService(
    ...
    suspend fun loginUser(
        ...
        println("userPermission: ${user.permission}")
