package com.angus.api_gateway.endpoints.utils
...
import com.angus.api_gateway.data.localizedMessages.Language
import com.angus.api_gateway.data.model.MultipartDto
...
fun Route.authenticateWithRole(role: Int, block: Route.() -> Unit) {
    authenticate("auth-jwt") {
        intercept(ApplicationCallPipeline.Call) {
            ...
            println("PERMISION$permission role $role")
