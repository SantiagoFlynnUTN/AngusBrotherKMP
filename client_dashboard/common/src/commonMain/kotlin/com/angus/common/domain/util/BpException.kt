...
open class AngusException(message: String) : Exception(message)

class UnknownErrorException(message: String) : AngusException(message)

class NoInternetException(message: String) : AngusException(message)

class NotFoundException(message: String) : AngusException(message)

class MultipleErrorException(val errors: List<BpError>) : AngusException("Multiple exceptions occurred")
