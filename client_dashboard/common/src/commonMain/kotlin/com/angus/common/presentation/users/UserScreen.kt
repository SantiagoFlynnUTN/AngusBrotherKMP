...
import com.angus.designSystem.ui.composable.BpIconButton
import com.angus.designSystem.ui.composable.BpSimpleTextField
...
private fun getCountryTitle(country: UserScreenUiState.Country): String {
    return when (country) {
        UserScreenUiState.Country.ARGENTINA -> Resources.Strings.argentina
    }
}
